...
def fun_with_ids
  ...
  1.times do
    ...
    puts "Outer ID and inner ID will be the same"
    ...
    puts "outer and outer_id will be different"
    ...
    puts "Inner id and outer_id will be the same"
  ...
  puts "Inner ids are not accessible and will throw an error."
  begin
